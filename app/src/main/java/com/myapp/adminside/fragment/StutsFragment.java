...
import com.myapp.adminside.adapter.StutsAdapter;
...
public class StutsFragment extends Fragment{
    ...
    private StutsAdapter adapter;
    private ProgressBarHelper progressBar;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_stuts,container,false);
        init();
        return view;
    }
    ...
    private void init() {
        ...
        adapter = new StutsAdapter(getActivity(), list);
    ...
    private void callApi() {
        ...
        api.getStuts().enqueue(new Callback<BaseResponse<Stuts>>() {
            @Override
            public void onResponse(Call<BaseResponse<Stuts>> call, Response<BaseResponse<Stuts>> response) {
...
//                    Functions.showToast(MainActivity.this, getString(R.string.try_again));
            ...
            @Override
            public void onFailure(Call<BaseResponse<Stuts>> call, Throwable t) {
                recyclerView.setVisibility(View.GONE);
                txtAlert.setVisibility(View.VISIBLE);
                progressBar.hideProgressDialog();
//                Functions.showToast(MainActivity.this, getString(R.string.try_again));
